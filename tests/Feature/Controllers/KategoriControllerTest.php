...
class KategoriControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_kategoris(): void
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_kategori(): void
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_kategori(): void
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_kategori(): void
    {
        $kategori = Kategori::factory()->create();
